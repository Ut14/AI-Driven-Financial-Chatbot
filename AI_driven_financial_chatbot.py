...
summary=pd.read_csv('Summary_final_report.csv')
...
def financial_chatbot():
    ...
    if user_query == "What is the total revenue?":
        ...
        return f"The Year By Year Average Revenue Growth Rate(%) from 2022 to 2024 for {company_input} is {year_avg_revenue_growth}(%)"
        ...
        return f"The Year By Year Net Income Revenue Growth Rate(%) from 2022 to 2024 for {company_input} is {year_avg_net_income_growth}(%)"
        ...
        return f"The Year By Year Average Assets Growth Rate(%) from 2022 to 2024 for {company_input} is {year_avg_assets_growth}(%)"
        ...
        return f"The Year By Year Average Liabilities Growth Rate(%) from 2022 to 2024 for {company_input} is {year_avg_liabilities_growth}(%)"
        ...
        return f"The Year By Year Average Cash Flow from Operations Growth Rate(%) from 2022 to 2024 for {company_input} is {year_avg_cash_ops_growth}(%)" 
...
while True:
    ...
    if user_input.lower() == "exit":
        ...
        if company_input not in ['Apple', 'Microsoft', 'Tesla']:
            ...
            if fiscal_year not in [2024, 2023, 2022]:
